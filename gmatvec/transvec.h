...
/*
 *  $Id: transvec.h,v 1.1 2001/12/07 11:59:46 cepek Exp $
 */
...
std::ostream& operator<<(std::ostream& out, const Vec<Float, Exc>& v)
  {
    ...
    MemRep<Float, Exc>::const_iterator b = v.begin();
    MemRep<Float, Exc>::const_iterator e = v.end();
    while (b != e)
      {
        out.width(fw);
        out << *b;
...
operator*(const TransVec<Float, Exc> &b, const Mat<Float, Exc> &A)
  {
    ...
    MemRep<Float, Exc>::const_iterator aj = A.begin();
