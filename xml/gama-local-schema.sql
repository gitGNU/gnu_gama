...
create table gnu_gama_local_configurations (
   ...
   algorithm varchar(12) default 'envelope' check (algorithm in ('svd', 'gso', 'cholesky', 'envelope')),
   epoch     double precision default 0.0,
   latitude  double precision default 50,
