/* Geodesy and Mapping C++ library (GNU GaMa) Copyright (C) 1999 Ales
   Cepek <cepek@fsv.cvut.cz> 2011 Vaclav Petras <wenzeslaus@gmail.com>
...
public:
    ...
    AdjustedObservationsTextVisitor(GNU_gama::local::LocalNetwork* localNetwork,
      ...
      v(residuals), consistent(localNetwork->PD.consistent())
    {
    }
...
void AdjustedObservations(GNU_gama::local::LocalNetwork* IS, OutStream& out)
{
   ...
   AdjustedObservationsTextVisitor<OutStream> textVisitor(IS, out, v, maxval);
